...
class UserMetrics:
    ...
    def process_user(self, user_id):
        ...
        if len(ulocations) >= 2:
            ...
            self.db.cur.execute('UPDATE user SET active=1,distances=%s,photos=%s,first_ts=%s,last_ts=%s,mean_time_interval=%s,locations=%s,herfindahl=%s,mean_distance=%s,mean_weighted_distance=%s,comments_given=%s,comments_received=%s,likes_given=%s,likes_received=%s WHERE id=%s'
